...
<body style="background-image: url('a.jpg');">
 ...
 $sql = 'SELECT * FROM stadion WHERE Drużyny LIKE :keyword OR Nazwa LIKE :keyword OR Liczba_miejsc LIKE :keyword OR Adres LIKE :keyword OR Miasto LIKE :keyword ORDER BY ID DESC ';
...
<table class='tbl-qa'>
 ...
 <tr>
   ...
   <th class='table-header' >Liczba miejsc</th>
   <th class='table-header' >Adres</th>
   <th class='table-header' >Miasto</th>
 ...
 ?>
   <tr class='table-row'>
   <td><?php echo $row['Drużyny']; ?></td>
   <td><?php echo $row['Nazwa']; ?></td>
   <td><?php echo $row['Liczba_miejsc']; ?></td>
   <td><?php echo $row['Adres']; ?></td>
   <td><?php echo $row['Miasto']; ?></td>
   <td><a style="text-align: left;" href="deletesta.php?id=<?php echo $row['ID']; ?>">Usuń</a></td>
...
<div class="pt-5">
          ...
          <form class="form-floating" action="stains.php" method="POST">

            <input type="text" class="form-control" name="Drużyny" placeholder="Drużyny">

            <input type="text" class="form-control" name="Nazwa" placeholder="Nazwa">

            <input type="text" class="form-control" name="Liczba_miejsc" placeholder="Liczba miejsc">
