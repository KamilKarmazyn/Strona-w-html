...
<body style="background-image: url('a.jpg');">
  ...
  <?php	
	...
	$sql = 'SELECT * FROM trenerzy WHERE Imie LIKE :keyword OR Nazwisko LIKE :keyword OR Wiek LIKE :keyword OR Druzyny LIKE :keyword ORDER BY ID DESC ';
...
<table class='tbl-qa'>
  ...
  <tbody id='table-body'>
    ...
    <td><a style="text-align: left;" href="deletetre.php?id=<?php echo $row['ID']; ?>">Usuń</a></td>
...
<div class="pt-5">
          ...
          <form class="form-floating" action="treins.php" method="POST">
         ...
         <input type="text" class="form-control" name="Wiek" placeholder="Wiek">

         <input type="text" class="form-control" name="Druzyny" placeholder="Druzyna">

         <input type="submit" style="float: right;" name="submit" value="Dodaj">
         </form> 
</div>
</div>
</body>
