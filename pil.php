...
<table class='tbl-qa'>
 ...
 ?>
   ...
   <td><a style="text-align: left;" href="deletepil.php?id=<?php echo $row['ID']; ?>">Usuń</a></td>
...
<div class="pt-5">
          ...
          <form class="form-floating" action="pilins.php" method="POST">
            ...
            <input type="text" class="form-control" name="Pozycja" placeholder="Pozycja">

            <input type="text" class="form-control" name="Druzyny" placeholder="Druzyny">
