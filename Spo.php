...
<body style="background-image: url('a.jpg');">
  ...
  <?php	
	...
	$sql = 'SELECT * FROM spotkania WHERE Dataspotk LIKE :keyword OR Czas LIKE :keyword OR Stadion LIKE :keyword OR Sedziowie LIKE :keyword OR Goscie LIKE :keyword OR Gospodarze LIKE :keyword OR Wynik LIKE :keyword ORDER BY ID DESC ';
...
<table class='tbl-qa'>
  <thead>
	<tr>
	  <th class='table-header' >Data Spotkania</th>
	  <th class='table-header' >Czas</th>
    <th class='table-header' >Stadion</th>
    <th class='table-header' >Sędziowie</th>
    <th class='table-header' >Goście</th>
    <th class='table-header' >Gospodarze</th>
  ...
  <tbody id='table-body'>
	...
	?>
	  <tr class='table-row'>
		<td><?php echo $row['Dataspotk']; ?></td>
		<td><?php echo $row['Czas']; ?></td>
		<td><?php echo $row['Stadion']; ?></td>
    <td><?php echo $row['Sedziowie']; ?></td>
